    ...
    <section id="o-nas" className="py-24 md:py-32 bg-cream">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="font-body text-base md:text-lg text-warm-gray leading-relaxed max-w-2xl mx-auto mb-6">
          Navštivte naše „Kulturní zařízení u Jurčíka" a zakuste jedinečnou
          atmosféru v naší restauraci s dlouholetou tradicí. Nabízíme příjemné
          posezení v tradiční české hospodě, výtečnou domácí kuchyni a znamenité
          tankové pivo.
        </p>
        <p className="font-body text-base md:text-lg text-warm-gray leading-relaxed max-w-2xl mx-auto">
          O obsluhu se postará příjemný a vždy usměvavý personál. V létě si
          užijte posezení ve stínu stoletých kaštanů, v zimě i létě ve stylové
          verandě.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 mt-16 grid md:grid-cols-2 gap-6">
        ...
        <div className="relative overflow-hidden group">
          <img
            ...
            alt="Stylová výzdoba restaurace U Jurčíka"
            className="w-full h-80 object-cover transition-transform duration-700 group-hover:scale-105"
            width={600}
            height={320}
            loading="lazy"
